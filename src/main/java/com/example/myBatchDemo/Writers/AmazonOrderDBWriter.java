...
@StepScope
public class AmazonOrderDBWriter implements ItemStreamWriter<AmazonOrder> {
    ...
    @Override
    public void write(@NonNull Chunk<? extends AmazonOrder> chunk) throws Exception {
        List<? extends AmazonOrder> items = chunk.getItems();
